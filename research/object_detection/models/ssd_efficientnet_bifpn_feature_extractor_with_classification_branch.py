...
class SSDEfficientNetBiFPNKerasFeatureExtractor_with_classification(
  ...
  def __init__(self,
    ...
    """
    super(SSDEfficientNetBiFPNKerasFeatureExtractor_with_classification, self).__init__(
    ...
    self._use_image_classification = True
    ...
    # return efficientnet base classification model
  ...
  def build(self, input_shape):
    self._bifpn_stage = bifpn_generators.KerasBiFpnFeatureMaps_with_classification(
...
class SSDEfficientNetB0BiFPNKerasFeatureExtractor(
    SSDEfficientNetBiFPNKerasFeatureExtractor_with_classification):
